 ...
 *
 * The function returns an empty array if no documents match the credential requirements.
 *
 ...
 *
 * @returns {Document[]} An array of Documents that match the credential requirements.
 ...
 *
 * const result = selectDocumentsClaimsByCredential(documents, credential);
 * // Returns: [] (no documents match the docType)
 * ```
 */
