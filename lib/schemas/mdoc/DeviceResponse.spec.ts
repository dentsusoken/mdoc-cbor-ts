...
/**
 * Test data for DeviceResponse validation
 * @description
 * Contains a base64url-encoded CBOR data that represents a valid DeviceResponse.
 * This data is used to verify that the DeviceResponse schema correctly validates
 * real-world mdoc responses.
 */
const base64url =
...
/**
 * Test suite for DeviceResponse schema validation
 * @description
 * Verifies that the DeviceResponse schema correctly validates real-world mdoc responses.
 * The test uses a base64url-encoded CBOR data that represents a valid DeviceResponse.
 */
